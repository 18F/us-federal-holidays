  ...
  describe('isAHoliday and isAHolidayUTC', () => {
    describe('federal reserve holidays', () => {
      it('should match all dates from json file', () => {
        for (let i = 0; i < federalReserveHolidays.length; i++) {
          ...
          let result = fedHolidays.isAHoliday(calendarDay, false);
          let resultUTC = fedHolidays.isAHolidayUTC(calendarDayUTC, false);
          console.assert(
            result == isHoliday,
            isHoliday,
            calendarDay,
    ...
    describe('calendar holidays', () => {
      let assertTrue = (date_s) => {
        let date = new Date(`${date_s} 00:00:00`);
        let dateUTC = new Date(`${date_s} 00:00:00 UTC`);
        let result = fedHolidays.isAHoliday(date, false, false);
        result.should.be.true();
        let resultUTC = fedHolidays.isAHolidayUTC(dateUTC, false, false);
        resultUTC.should.be.true();
      }
      let assertFalse = (date_s) => {
        let date = new Date(`${date_s} 00:00:00`);
      ...
      describe('unshifted Saturdays', () => {
        it('should return false for the day before Independence Day, Friday 2020-07-03', async () => {
          let date_s = '2020-07-03';
          assertFalse(date_s);
        });
        it('should return true for Independence Day, Saturday 2020-07-04', async () => {
          let date_s = '2020-07-04';
          assertTrue(date_s);
        });
        it('should return false for the day before New Years Day, Friday 2010-12-31', async () => {
          let date_s = '2010-12-31';
          assertFalse(date_s);
        });
        it('should return true for New Years Day, Saturday 2011-01-01', async () => {
          let date_s = '2011-01-01';
          assertTrue(date_s);
        });
      });
      describe('unshifted Sundays', () => {
        it('should return true for Veterans Day, Sunday 2018-11-11', async () => {
          let date_s = '2018-11-11';
          assertTrue(date_s);
        });
        it('should return false for the day after Veterans Day, Monday 2018-11-12', async () => {
          let date_s = '2018-11-12';
          assertFalse(date_s);
        });
        it('should return true for Independence Day, Sunday 2021-07-04', async () => {
          let date_s = '2021-07-04';
          assertTrue(date_s);
        });
        it('should return false for the day after Independence Day, Monday 2021-07-05', async () => {
          let date_s = '2021-07-05';
          assertFalse(date_s);
        });
      });
